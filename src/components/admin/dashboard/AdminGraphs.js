...
//   return date.toLocaleDateString("en-GB", { day: "2-digit", month: "short" }); // eg. 19 Jul
// }
...
//         // Group and count by date and indicatorStatus
//         const dateMap = {};

//         indicators.forEach((item) => {
//           const date = formatDate(item.responseDate);
//           if (!dateMap[date]) {
//             dateMap[date] = { date, stable: 0, alert: 0 };
//           }
//           if (item.indicatorStatus === "Stable") dateMap[date].stable += 1;
//           else if (item.indicatorStatus === "Urgent" || item.indicatorStatus === "Alert") dateMap[date].alert += 1;
//         });
...
//   return (
//     <Box sx={{ p: { xs: 1, md: 3 }, width: "100%", minHeight: 350 }}>
...
//           <Grid  size={{xs:12}}>
//             <Paper sx={{ p: 3, borderRadius: 4, minHeight: 330, boxShadow: 3 }}>
